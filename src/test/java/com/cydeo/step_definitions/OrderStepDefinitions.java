...
public class OrderStepDefinitions {
    ...
    public void userEntersQuantity(int quantity) {
        //since sendKeys() method only accepts String ,we need to either concat with empty string
        //or send String.valueOf(int)
        // if we pass int as a parameter instead of string then we have to do it as below
        //orderPage.inputQuantity.sendKeys(String.valueOf(quantity));

        //clear() method will delete whatever is in the input box or we can use backspace
